...
int main(int argc, char **argv) {
    {
        ...
        // 注意：Windows/MSVC 64位下 std::vector 本身大小是24字节（3个指针）
    ...
    }
    {
        ...
        {
            vec.push_back('a');  // 索引16
            vec.push_back('b');  // 索引17
            vec.push_back('c');  // 索引18
            vec.push_back('d');  // 索引19
